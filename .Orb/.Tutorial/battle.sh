...
if [ $usr_hp -le 0 ]; then
echo "$team_name: Get your head in the game! You won't have a second chance on the battlefield."
else
echo "$team_name: Good work! Seems like your injuries weren't too bad."
fi
echo "$team_name: If you want another chance to spar, type 'source battle.sh' once again. If not, lets start go back to camp by typing 'cd ..'"
tut_done=1
