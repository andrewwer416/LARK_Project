#!/usr/bin/bash
enemy_name="???"
echo -e "${BLUE}$enemy_name${NC}: I was wondering when you would find your way back here... Oh right, I never did get your
REAL name."
read -p "Could you please tell me? " real_name
enemy_name="Cerberus"
echo -e "${BLUE}$enemy_name${NC}: Thank you. I will formally introduce myself as $enemy_name. \
...
echo -e "${BLUE}$enemy_name${NC}: Enough of all that though. After all, that is not why you're here today. \
